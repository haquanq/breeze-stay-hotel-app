...
namespace HotelManagement.WinformApp.Views.Room
{
    ...
    {
        public static RoomDetailView _self;

        private DataTable dtbReservationHistory = new DataTable();
        private string selectedRoomId;

        public RoomDetailView(string selectedRoomId)
        {
            InitializeComponent();
            _self = this;
        ...
        public void LoadRoomDetail()
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    ...
                    lblPrice.Text = DoubleExtension.ToCurrency(Convert.ToInt32(cells["price_per_night"]));
        ...
        private void PaintReservationStatusColor(object sender, DataGridViewCellPaintingEventArgs e)
        {
        }
