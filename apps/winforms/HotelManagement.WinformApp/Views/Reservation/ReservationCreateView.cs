...
namespace HotelManagement.WinformApp.Views.Reservation
{
    public partial class ReservationCreateView : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@staff_id", LoginView.currentUser.StaffId);
        ...
        private void btnMoreCustomerDetail_Click(object sender, EventArgs e)
        {
            ...
            var f = new CustomerDetailView(txtCustomerId.Text);
            f.ShowDialog();
        }
