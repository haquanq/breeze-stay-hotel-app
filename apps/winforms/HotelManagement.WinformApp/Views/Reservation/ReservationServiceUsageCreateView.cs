...
{
    public partial class ReservationServiceUsageCreateView : Form
    {

        private DataTable dtbHotelService = new DataTable();
        private string selecetedReservationId;

        public ReservationServiceUsageCreateView(string selecetedReservationId)
        {
            InitializeComponent();
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReservationServiceUsageView._self.LoadReservationAndHotelServiceUsage();
            }
            catch (Exception ex)
            {
