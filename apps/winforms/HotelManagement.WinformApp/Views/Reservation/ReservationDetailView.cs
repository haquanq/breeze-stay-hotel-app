...
using HotelManagement.WinformApp.Views.RoomAmentiyUsage;
...
{
    public partial class ReservationDetailView : Form
    {
        public static ReservationDetailView _self;
        ...
        public ReservationDetailView(string selectedReservationId)
        {
            InitializeComponent();
            _self = this;
        ...
        public void LoadReservationBySelectedId()
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                using (var dr = cmd.ExecuteReader())
                {
                    ...
                    {
                        lblTotalBalance.Text = $"Total balance: {DoubleExtension.ToCurrency(Convert.ToInt32(cells["total_price"]))}";
                    }
                ...
                cmd.CommandText = "select b.id, b.room_code, b.floor_number, " +
                    " c.id as room_type_id, c.title as room_type_title, a.price_per_night from reservation_room a" +
        ...
        {
            var f = new CustomerDetailView(lblCustomerId.Text);
            f.ShowDialog();
        }
        ...
        {
            var f = new ReservationServiceUsageView(selectedReservationId);
            f.ShowDialog();
        }

        private void btnCheckOut_Click(object sender, EventArgs e)
        {
            var f = new ReservationCheckOutView(selectedReservationId);
            f.ShowDialog();
        }
        ...
        private void btnExportInvoice_Click(object sender, EventArgs e)
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                using (var dr = cmd.ExecuteReader())
                {
                    ...
                    total = DoubleExtension.YieldThousandDelimiter(Convert.ToInt32(cells["total_price"]));
            ...
            string subTotal = DoubleExtension.ToCurrency(
                Convert.ToDouble(
            ...
            viewer.LocalReport.SetParameters(new ReportParameter[]
            {
                    ...
                    new ReportParameter("staff_name", LoginView.currentUser.FullName),
