...
namespace HotelManagement.WinformApp.Views.Main
{
    ...
    {
        public static DashboardView _self;
        ...
        {
            /// MainView.instance.NavigateToRoomWithStatus(null);
        }

        private void btnDirtyVacantRoom_Click(object sender, EventArgs e)
        {
            /// MainView.instance.NavigateToRoomWithStatus(RoomStatus.VACANT_DIRTY.ToString());
        }

        private void btnCleanVacantRoom_Click(object sender, EventArgs e)
        {
            // MainView.instance.NavigateToRoomWithStatus(RoomStatus.VACANT_CLEAN.ToString());
        }

        private void btnBookedRoom_Click(object sender, EventArgs e)
        {
            // MainView.instance.NavigateToRoomWithStatus(RoomStatus.BOOKED.ToString());
        }

        private void btnOccupiedRoom_Click(object sender, EventArgs e)
        {
            // MainView.instance.NavigateToRoomWithStatus(RoomStatus.OCCUPIED.ToString());
        }

        private void btnReadyRoom_Click(object sender, EventArgs e)
        {
            // MainView.instance.NavigateToRoomWithStatus(RoomStatus.READY.ToString());
        }
    }
}
